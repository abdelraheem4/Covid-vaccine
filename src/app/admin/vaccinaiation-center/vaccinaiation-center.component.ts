...
@Component({
  selector: 'app-vaccinaiation-center',
  templateUrl: './vaccinaiation-center.component.html',
  styleUrls: ['./vaccinaiation-center.component.css']
})
export class VaccinaiationCenterComponent implements OnInit {
